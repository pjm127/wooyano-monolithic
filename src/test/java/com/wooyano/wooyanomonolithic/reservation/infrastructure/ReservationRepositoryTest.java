...
class ReservationRepositoryTest {
    ...
    public void findByReservationGoodsId(){
        ...
        // when
        Optional<Reservation> result = reservationRepository.findByReservationGoodsId(reservationGoods.getId(), 1L);

        // then
        assertThat(result).isPresent();
        Reservation foundReservation = result.get();
        assertThat(foundReservation.getReservationGoods()).isEqualTo(reservationGoods);
